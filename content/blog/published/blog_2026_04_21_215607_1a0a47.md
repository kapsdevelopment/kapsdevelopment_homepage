...
RAG becomes worth it when the assistant must reliably answer with knowledge that is not safely resident in the base model. For the Sathu app with Boon, the special flavor of buddhism and thai culture combined could hardly be relient on pure LLM responses alone. 
